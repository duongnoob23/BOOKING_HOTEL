...
export const fetchHotelList = createAsyncThunk(
  ...
  async (_, { getState, rejectWithValue }) => {
    try {
      ...
      if (!data?.data) {
        return rejectWithValue("Dữ liệu khách sạn không hợp lệ");
      }
...
export const fetchHotelById = createAsyncThunk(
  ...
  async (hotelId, { rejectWithValue }) => {
    try {
      ...
      //   return rejectWithValue("ID khách sạn không hợp lệ");
      // }
      ...
      // if (!data?.data) {
      //   return rejectWithValue("Dữ liệu chi tiết khách sạn không hợp lệ");
      // }
...
export const fetchLocationList = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      if (!data?.data) {
        return rejectWithValue("Dữ liệu địa điểm không hợp lệ");
      }
  ...
  async (value, { getState, rejectWithValue }) => {
    try {
      if (!value || typeof value !== "object") {
        return rejectWithValue("Dữ liệu lọc khách sạn không hợp lệ");
      }
...
export const fetchHotelRoomList = createAsyncThunk(
  ...
  async (value, { rejectWithValue }) => {
    try {
      if (!value || typeof value !== "object") {
        return rejectWithValue("Dữ liệu yêu cầu phòng không hợp lệ");
      }
...
export const fetchBookingRoom = createAsyncThunk(
  ...
  async (_, { getState, rejectWithValue }) => {
    try {
      ...
      if (!accessToken) {
        return rejectWithValue("Không có token để đặt phòng");
      }
...
export const fetchBookingStatus = createAsyncThunk(
  ...
  async (_, { getState, rejectWithValue }) => {
    try {
      ...
      if (!accessToken) {
        return rejectWithValue("Không có token để lấy trạng thái đặt phòng");
      }
      ...
      if (!data?.data) {
        return rejectWithValue("Dữ liệu trạng thái đặt phòng không hợp lệ");
      }
  ...
  async (reviewId, { getState, rejectWithValue }) => {
    try {
      if (!reviewId || typeof reviewId !== "string") {
        return rejectWithValue("ID đánh giá không hợp lệ");
      }
      ...
      if (!data?.data) {
        return rejectWithValue("Dữ liệu đánh giá không hợp lệ");
      }
...
export const sendReview = createAsyncThunk(
  ...
  async (reviewData, { getState, rejectWithValue }) => {
    try {
      ...
      const accessToken = state.auth?.accessToken;
      if (!accessToken) {
        return rejectWithValue("Không có token để gửi đánh giá");
      }
